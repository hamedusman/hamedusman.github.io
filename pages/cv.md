...
<h3 style="font-family:courier">RESEARCH</h3>
 ...
 <ul style="list-style-type:none;"><a style="font-family:courier; font-size:13px">Book Chapter</a>
  ...
  <ul style="list-style-type:none;"><a style="font-family:courier; font-size:13px">Master's Thesis Advising</a>
    <ul style="list-style-type:none;">
     <li><p>Hira Waris (MS in SCM, Bahria University, Islamabad, Pakistan; graduated in Spring 2023)</p></li>
      <ul style="list-style-type:none;"><li>- Thesis Title: The relationship between inventory leanness, dynamism, and sustainability of firms: In context of US-based clean 200 companies</li></ul>
     <li><p>Kanwal Iftikhar (MS in SCM, Bahria University, Islamabad, Pakistan; expected to graduate in Fall 2023)</p></li>
     <li><p>Naida Arif (MS in SCM, Bahria University, Islamabad, Pakistan; expected to graduate in Fall 2023)</p></li>
    </ul>
  </ul>
