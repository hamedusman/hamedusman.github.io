...
<h5>RESEARCH</h5>
 ...
 <ul style="list-style-type:none;">Methodology
  ...
  <ul style="list-style-type:none;">Master's Thesis Advising
    <ol>
     <li>Hira Waris <i>(MS in SCM, Bahria University, Islamabad, Pk; Graduated in Spring 2023; Grade: A-)</i></li>
     ...
     <li>Kanwal Iftikhar <i>(MS in SCM, Bahria University, Islamabad, PK; Graduated in Fall 2023; Grade: A+)</i></li>
     <li>Naida Arif <i>(MS in SCM, Bahria University, Islamabad, PK; Graduated in Fall 2023; Grade: A+)</i></li>
     <li>Quratulain Marriam <i>(MS in SCM, Bahria University, Islamabad, PK; Graduated in Spring 2024; Grade: A+)</i></li>
     <li>Quratulain Javed <i>(MS in SCM, Bahria University, Islamabad, PK; Expected to Graduate in Fall 2024)</i></li>
    </ol>
  </ul>
